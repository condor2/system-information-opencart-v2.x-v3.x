...
<div id="et-content">
    ...
    <table class="uk-table uk-table-striped uk-table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $date_php_now; ?></td>
            </tr>
            <tr>
                <td><?php echo $text_php_time_now; ?></td>
                <td><?php echo $time_php_now; ?></td>
            </tr>
            <tr>
                <td><?php echo $text_db_date_now; ?></td>
                <td><?php echo $date_db_now; ?> <?php echo !$match_date ? '<span class="uk-text-small uk-text-danger uk-margin-left">' . $text_date_unmatch . '<span>' : ''; ?></td>
            </tr>
            <tr>
                <td><?php echo $text_db_time_now; ?></td>
                <td><?php echo $time_db_now; ?> <?php echo !$match_time ? '<span class="uk-text-small uk-text-danger uk-margin-left">' . $text_time_unmatch . '<span>' : ''; ?></td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="uk-table uk-table-striped uk-table-hover uk-text-center">
        ...
        <tbody>
            <tr>
                ...
                <td><?php echo (phpversion() >= '5.4') ? '<i class="uk-icon-check uk-icon-small uk-text-success"></i>' : '<i class="uk-icon-times uk-icon-small uk-text-danger"></i>'; ?></td>
            </tr>
            <tr>
    ...
    <table class="uk-table uk-table-striped uk-table-hover uk-text-center">
        ...
        <tbody>
            ...
            <?php if (!function_exists('iconv')) { ?>
                <tr>
                    <td class="uk-text-left"><?php echo $text_mbstring; ?></td>
                    <td><?php echo $text_on; ?></td>
                    <td><?php echo extension_loaded('mbstring') ? 'On' : '<span class="uk-badge uk-badge-danger">'.$text_off.'</span>'; ?></td>
                    <td><?php echo extension_loaded('mbstring') ? '<i class="uk-icon-check uk-icon-small uk-text-success"></i>' : '<i class="uk-icon-times uk-icon-small uk-text-danger"></i>'; ?></td>
                </tr>
            <?php } ?>
            <tr>
            ...
            <tr>
                <td class="uk-text-left"><?php echo $text_zlib; ?></td>
                <td><?php echo $text_on; ?></td>
            ...
            <tr>
                ...
                <td><?php echo $text_on; ?></td>
                <td><?php echo extension_loaded('zip') ? 'On' : '<span class="uk-badge uk-badge-danger">'.$text_off.'</span>'; ?></td>
                <td><?php echo extension_loaded('zip') ? '<i class="uk-icon-check uk-icon-small uk-text-success"></i>' : '<i class="uk-icon-times uk-icon-small uk-text-danger"></i>'; ?></td>
            </tr>
            <tr>
    ...
    <h3 class="uk-margin-small-bottom"><?php echo $section_basic_security; ?></h3>
    <p class="uk-text-small uk-margin-small-top">Basic security practices as suggested on OpenCart <a href="http://docs.opencart.com/administration/security/" target="_blank">documentation</a> the following files need to be set to <code>644</code> or <code>444</code>.</p>
    <table class="uk-table uk-table-striped uk-table-hover uk-text-center">
        <thead>
            <tr>
                <th><?php echo $text_files; ?></th>
        ...
        <tbody>
            <tr>
                <td class="uk-text-left">index.php</td>
                <td><?php echo substr(sprintf('%o', fileperms(DIR_APPLICATION . '../index.php')), -3); ?></td>
                <td><?php echo is_writable(DIR_APPLICATION . '../index.php') ? '<span class="uk-badge uk-badge-warning">' . $text_writable . '</span>' : '<span class="uk-badge uk-badge-success">' . $text_unwritable . '</span>'; ?></td>
            </tr>
            <tr>
                <td class="uk-text-left">config.php</td>
                <td><?php echo substr(sprintf('%o', fileperms(DIR_APPLICATION . '../config.php')), -3); ?></td>
                <td><?php echo is_writable(DIR_APPLICATION . '../config.php') ? '<span class="uk-badge uk-badge-warning">' . $text_writable . '</span>' : '<span class="uk-badge uk-badge-success">' . $text_unwritable . '</span>'; ?></td>
            </tr>
            <tr>
                <td class="uk-text-left">admin/index.php</td>
                <td><?php echo substr(sprintf('%o', fileperms(DIR_APPLICATION . 'index.php')), -3); ?></td>
                <td><?php echo is_writable(DIR_APPLICATION . 'index.php') ? '<span class="uk-badge uk-badge-warning">' . $text_writable . '</span>' : '<span class="uk-badge uk-badge-success">' . $text_unwritable . '</span>'; ?></td>
            </tr>
            <tr>
                <td class="uk-text-left">admin/config.php</td>
                <td><?php echo substr(sprintf('%o', fileperms(DIR_APPLICATION . 'config.php')), -3); ?></td>
                <td><?php echo is_writable(DIR_APPLICATION . 'config.php') ? '<span class="uk-badge uk-badge-warning">' . $text_writable . '</span>' : '<span class="uk-badge uk-badge-success">' . $text_unwritable . '</span>'; ?></td>
            </tr>
            <tr>
                <td class="uk-text-left">system/framework.php</td>
                <td><?php echo substr(sprintf('%o', fileperms(DIR_APPLICATION . '../system/framework.php')), -3); ?></td>
                <td><?php echo is_writable(DIR_APPLICATION . '../system/framework.php') ? '<span class="uk-badge uk-badge-warning">' . $text_writable . '</span>' : '<span class="uk-badge uk-badge-success">' . $text_unwritable . '</span>'; ?></td>
            </tr>
            <tr>
                <td class="uk-text-left">system/startup.php</td>
                <td><?php echo substr(sprintf('%o', fileperms(DIR_APPLICATION . '../system/startup.php')), -3); ?></td>
                <td><?php echo is_writable(DIR_APPLICATION . '../system/startup.php') ? '<span class="uk-badge uk-badge-warning">' . $text_writable . '</span>' : '<span class="uk-badge uk-badge-success">' . $text_unwritable . '</span>'; ?></td>
            </tr>
        </tbody>
    </table>

    <h3><?php echo $text_directories; ?></h3>
    <table class="uk-table uk-table-striped uk-table-hover uk-text-center">
        <thead>
            <tr>
